...
all_valid_zones = set()
for i, (min_poi_count, spend_percent, poi_percent_cap, year, sub_category, top_category) in enumerate(hard_16_test_cases):
    obj_path = f"/Users/mihokoda/Desktop/CityLLM/test_results/hard/16/tc_hard_16_{i}/objective.csv"
