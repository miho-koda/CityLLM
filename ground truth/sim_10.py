...
all_valid_zones = set()
for i, (num, transportation_type) in enumerate(simple_10_test_cases):
    obj_path = f'/Users/mihokoda/Desktop/CityLLM/test_results/sim/10/tc_sim_10_{i}/objective.csv'
    obj = pd.read_csv(obj_path)
    obj_zones = set(obj['zone_id'].unique())
    
    valid_zones_df = simple_10(num, transportation_type)
