...
all_valid_zones = set()
for i, (num_competitors, population, num_zones, num_parking, start_year, end_year, spend_filters, sub_category, top_category) in enumerate(hard_15_test_cases):
    obj_path = f"/Users/mihokoda/Desktop/CityLLM/test_results/hard/15/tc_hard_15_{i}/objective.csv"
