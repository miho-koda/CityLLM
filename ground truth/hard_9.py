...
for i, (num_competitors, comp_op,
    population, pop_op,
    num_zones,
    num_parking, park_op,
    sub_category, top_category) in enumerate(hard_9_test_cases):
    obj_path = f"/Users/mihokoda/Desktop/CityLLM/test_results/hard/9/tc_hard_9_{i}/objective.csv"
