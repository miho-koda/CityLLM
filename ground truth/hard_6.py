...
for i, (top_cat, sub_cat, comp_thresh, comp_op, park_thresh, pop_thresh, pop_op, neigh_count, park_op) in enumerate(hard_6_test_cases):
    obj_path = f"/Users/mihokoda/Desktop/CityLLM/test_results/hard/6/tc_hard_6_{i}/objective.csv"
    ...
    result_df = hard_6(
        ...
        competitor_threshold=comp_thresh,
        competitor_op=comp_op,
        parking_threshold=park_thresh,
        population_threshold=pop_thresh,
        population_op=pop_op,
