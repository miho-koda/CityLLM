...
for i, (num_pois1, sub_categories, num_parking, num_pois2, num_transport, transport_type, sub_category2) in enumerate(hard_14_test_cases):
    obj_path = f"/Users/mihokoda/Desktop/CityLLM/test_results/hard/14/tc_hard_14_{i}/objective.csv"
