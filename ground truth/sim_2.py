...
for i, num in enumerate(simple_2_test_cases):
    obj_path = f'/Users/mihokoda/Desktop/CityLLM/test_results/sim/2/tc_sim_2_{i}/objective.csv'
    obj = pd.read_csv(obj_path)
    obj_zones = set(obj['zone_id'].unique())
    
    valid_zones_df = simple_2(num)
