...
for i, (num_competitors, comp_op, num_pois, poi_op, num_transport, transport_op, num_parking, parking_op, transport_type, sub_category, top_category) in enumerate(hard_8_test_cases):
    obj_path = f"/Users/mihokoda/Desktop/CityLLM/test_results/hard/8/tc_hard_8_{i}/objective.csv"
